...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_group_has_avatar() ) : ?>
				...
				<?php bp_button( array( 'id' => 'delete_group_avatar', 'component' => 'groups', 'wrapper_id' => 'delete-group-avatar-button', 'link_class' => 'edit', 'link_href' => bp_get_group_avatar_delete_link(), 'link_title' => __( 'Smazat náhledový obrázek', 'buddypress' ), 'link_text' => __( 'Smazat náhledový obrázek', 'buddypress' ) ) ); ?>
	...
	<div class="bp-widget">
		...
		<?php else: ?>
			...
			<div id="message" class="info">
				<p><?php _e( 'Tato skupina nemá žádné členy.', 'buddypress' ); ?></p>
			</div>
