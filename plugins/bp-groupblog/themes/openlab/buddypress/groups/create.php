                ...
                <?php if (bp_is_group_creation_step('group-details')) : ?>
					...
					<?php if ( 'course' === $group_type ) : ?>
						<p class="copyright-notice italics">
							<strong>Copyright Note:</strong> Jakýkoli obsah, který vy nebo vaši studenti vytvoříte a zveřejníte v OpenLabu, včetně tohoto kurzu, je automaticky chráněn za podmínek  <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">licence Creative Commons Attribution NonCommercial Share-Alike 3.0</a>, nebo jakékoli následné licence Creative Commons. Můžete však určit další podmínky autorských práv (<a href="https://creativecommons.org/faq/">Další informace naleznete zde</a>). Budete muset zadat licenci na profilu kurzu a souvisejících webových stránek, pokud se liší od obecné <a href = "https://lab.urad.online/about/terms-of-service/#license-to-site -user "> licence OpenLab </a>. Prosíme <a href="https://lab.urad.online/blog/help/contact-us">kontaktujte nás </a> s dotazem nebo <a href ="https://lab.urad.online/blog/help/copyright-and-fair-use-2/">čtěte více v sekci nápovědy </a>.
						</p>
					<?php endif; ?>
