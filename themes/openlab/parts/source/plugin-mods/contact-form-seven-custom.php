...
<div id="workshop-meeting-items">
    ...
    <p>
        <label for="reason-for-request">Důvod požadavku (vyžadováno)</label>
    ...
    <p>
        <label for="need-computer-lab">Potřebujete počítačovou laboratoř? Pokud ano, je odpovědný za rezervaci. (vyžadováno)</label><br />
