...
function openlab_google_font() {
	wp_register_style('google-fonts', set_url_scheme( 'https://fonts.googleapis.com/css?family=Arvo' ),get_bloginfo( 'stylesheet_url' ));
...
echo xprofile_get_field_id_from_name('Account Type ');
