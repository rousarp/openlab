...
<div id="item-body" role="main">
    ...
    <form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form form-panel" id="settings-form">
        ...
        <div class="form-group settings-section email-section">
            ...
            <p class="description">Vaše e-mailová adresa nemůže být změněna. Pokud se změnila e-mailová adresa vaší organizace, <a class="underline" href="<?php bp_get_root_domain(); ?>/about/contact-us">kontaktujte nás</a> s žádostí o pomoc.</p>
        </div>
        ...
        <div class="form-group settings-section current-pw-section">
            ...
            <p class="description">Požadujete změnu <?php echo $include_acct_type ?>aktuálního hesla, jména nebo příjmení. <a class="underline" href="<?php echo site_url(add_query_arg(array('action' => 'lostpassword'), 'wp-login.php'), 'login'); ?>" title="<?php _e('Password Lost and Found', 'buddypress'); ?>"><?php _e('Lost your password?', 'buddypress'); ?></a></p>
        </div>

        <div class="form-group settings-section change-pw-section">
            <label for="pass1">Změna hesla</label>
            ...
            <p class="description">Ponechte prázdné pro ponechání beze změn.</p>
        </div>
