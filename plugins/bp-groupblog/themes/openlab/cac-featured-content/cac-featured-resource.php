        ...
        <?php if ($cfcw_view->display_images && $cfcw_view->image_url): ?>
            ...
            <div class="col-xs-12 cfcw-image-wrapper">
                <a href="<?php echo esc_url($cfcw_view->resource_link) ?>">
                    <img src="<?php echo $cfcw_view->image_url ?>" alt="V centru pozornosti: <?php echo $cfcw_view->resource_title ?>" class="img-responsive" />
                </a>
            </div>
            ...
            <div class="col-xs-12 cfcw-copy-wrapper">
                ...
                <p class="see-more"><a class="semibold" href="<?php echo esc_url($cfcw_view->resource_link) ?>"><?php echo __('Zobrazit více', 'cac-featured-content') ?><span class="sr-only"> <?php echo __('about this In the Spotlight', 'cac-featured-content') ?></span></a></p>
            </div>
