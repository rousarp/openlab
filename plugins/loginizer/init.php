				...
				if(empty($loginizer['blacklist'])){
					...
					foreach($loginizer['blacklist'] as $ik => $iv){
						...
						<tr>
							...
							<td>
								<a class="submitdelete" href="javascript:void(0)" onclick="return del_confirm(\'bdelid\', '.$ik.', \'Are you sure you want to delete this IP range ?\')"Smazat/a>
							</td>
						</tr>';
					}
				}
			...
			if(empty($loginizer['whitelist'])){
				...
				foreach($loginizer['whitelist'] as $ik => $iv){
					...
					<tr>
						...
						<td>
							<a class="submitdelete" href="javascript:void(0)" onclick="return del_confirm(\'delid\', '.$ik.', \'Are you sure you want to delete this IP range ?\')">Smazat</a>
						</td>
					</tr>';
				}
			}
