...
function cuny_home_login() {
    ...
    if (is_user_logged_in()) :
        ...
        echo '<h1 class="title inline-element semibold hyphenate">Welcome, ' . bp_core_get_user_displayname(bp_loggedin_user_id()) . '</h1>';
        ...
        <div class="col-sm-6 activity-list <?php echo $type; ?>-list">
            <div class="activity-wrapper">
                <div class="title-wrapper">
                    <h2 class="title activity-title"><a class="no-deco" href="<?php echo site_url() . '/' . strtolower($type); ?>s"><?php echo ucfirst(_x($type,'1M','openlab')); ?><span class="fa fa-chevron-circle-right" aria-hidden="true"></span></a></h2>
                </div><!--title-wrapper-->
                <?php
