            ...
            <div class="container-fluid footer-desktop">
                <div class="row row-footer">
                    <div class="col-sm-12">
                        <div class="col-logos">
                            ...
                            <div class="logos-wrapper clearfix">
                                ...
                                <a class="pull-left cuny-logo" href=" <?php echo get_site_url( 1 ) ?> " target="_blank"><img class="img-responsive" src="https://lab.urad.online/wp-content/mu-plugins/css/images/openlab_menu_logo.png" alt="Úřad online" border="0" /></a>
                    ...
                    <div class="col-sm-8 col-links semibold">
                        ...
                        <a class="no-deco roll-over-color" href="<?php echo $site; ?>/blog/help/napoveda-openlab/">Návody</a> <span class="horiz-divider">|</span> <a class="no-deco roll-over-color" href="<?php echo $site; ?>/about/contact-us/">Kontaktujte nás</a> <span class="horiz-divider">|</span> <a class="no-deco roll-over-color" href="<?php echo $site; ?>/about/zasady-ochrany-osobnich-udaju/">Ochrana osobních údajů</a> <span class="horiz-divider">|</span> <a class="no-deco roll-over-color" href="<?php echo $site; ?>/about/podminky-pouziti/">Podmínky použití</a> <span class="horiz-divider">|</span> <a class="no-deco roll-over-color" href="<?php echo $site; ?>/about/kredity/">Autoři</a>
                        <?php if ($accessibility_link && !empty($accessibility_link) && $accessibility_link !== 0): ?>
                            <h2 class="second-header">Přístupnost</h2>
                            <p class="statement">Naším cílem je zpřístupnit OpenLab všem uživatelům.</p>
                            <p class="statement"><a class="deco roll-over-color" href="<?php echo get_permalink($accessibility_link) ?>">Další informace o dostupnosti aplikace OpenLab</a></p>
                        <?php endif; ?>
                    </div>
                    <div class="horiz-bar-wrapper"><div class="horiz-bar"></div></div>
