<div class="ab-sub-wrapper">
    <div class="ab-submenu">
        <form name="login-form" style="display:none;" id="sidebar-login-form" class="standard-form form" action="<?php echo site_url("wp-login.php", "login_post") ?>" method="post">
            ...
            <p class="forgetmenot checkbox"><label><input name="rememberme" type="checkbox" id="dropdown-rememberme" value="forever" /> <?php _e("Neodhlašovat", "buddypress") ?></label></p>
            <input type="hidden" name="redirect_to" value="<?php echo bp_get_root_domain() . $request_uri; ?>" />
            ...
            <span class="exit"><a href="<?php echo wp_lostpassword_url(); ?>" class="lost-pw">Zapomněli jste heslo?</a></span>
        </form>
    </div>
</div>
