<h4><?php _e( 'Změnit náhledový obrázek', 'buddypress' ); ?></h4>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				<p><?php _e( "Chcete-li smazat váš aktuální náhledový obrázek, ale neinstalovat nový, použijte tlačítko Odstranit avatar.", 'buddypress' ); ?></p>
				<p><a class="button edit" href="<?php bp_avatar_delete_link(); ?>" title="<?php esc_attr_e( 'Smazat náhledový obrázek', 'buddypress' ); ?>"><?php _e( 'Smazat náhledový obrázek', 'buddypress' ); ?></a></p>
			<?php endif; ?>
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<h5><?php _e( 'Oříznout váš nový náhledový obrázek', 'buddypress' ); ?></h5>
