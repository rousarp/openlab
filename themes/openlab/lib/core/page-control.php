...
function openlab_custom_pages() {
    ...
    openlab_custom_page('calendar', 'OpenLab Kalendář', array($about_page_obj));

    $calendar_page_obj = get_page_by_path('about/calendar');
    openlab_custom_page('upcoming', 'OpenLab Kalendář: Nadcházející události', array($about_page_obj, $calendar_page_obj));
}
