	        ...
	        <li><a href="#groupblog_about"><?php _e('About', 'bp-groupblog'); ?></a></li>
				...
				<div id='groupblog_landing_page'>
					...
					<table class="form-table">
						...
						<tr>
							...
							<td>
								<label><input class="info-off" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="0" type="radio" <?php if ($opt['redirectblog']== 0) echo 'checked="checked"'; ?> > <?php _e( 'Disabled', 'bp-groupblog' ) ?></label>
							</td>
						</tr>
						<tr>
							<th></th>
							<td>
								<label><input class="info-off" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="1" type="radio" <?php if ($opt['redirectblog']== 1) echo 'checked="checked"'; ?> > <?php _e( 'Home Page', 'bp-groupblog' ) ?></label>
							</td>
						<tr>
							<th></th>
							<td>
								<label><input class="info-on" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="2" type="radio" <?php if ($opt['redirectblog']== 2) echo 'checked="checked"'; ?> > <?php _e( 'Page Template Title: ', 'bp-groupblog' ) ?></label>
				...
				<?php if ( $opt['theme'] == 'p2|p2-buddypress' )	{ ?>
					...
					<table class="enabled" id="availablethemes" cellspacing="0" cellpadding="0">
						...
						<tr class="alt">
							<td class="available-theme top left">
								...
								<div class="clear"></div>
								<input name="page_template_layout" id="page_template_layout"  value="magazine" type="radio" <?php if ($opt['page_template_layout'] == 'magazine') echo 'checked="checked"'; ?>  /><h3 style="display:inline;"> <?php _e( 'Magazine', 'bp-groupblog' ) ?></h3>
							...
							<td class="available-theme top">
								...
								<div class="clear"></div>
								<input name="page_template_layout" id="page_template_layout"  value="microblog" type="radio" <?php if ($opt['page_template_layout'] == 'microblog') echo 'checked="checked"'; ?> /><h3 style="display:inline;"> <?php _e( 'Microblog', 'bp-groupblog' ) ?></h3>
					...
					<tbody>
						<tr>
							...
							<td>
								<label for="group_admin_layout"><input name="group_admin_layout" type="checkbox" id="group_admin_layout" value="1" <?php if ($opt['group_admin_layout'] == 1) echo('checked="checked"'); ?> /> <?php _e( 'Allow group admins to select the layout for their group themselves.', 'bp-groupblog' ) ?></label>
					  	</td>
						</tr>
						</tbody>
					</table>
		      ...
		      <h3><?php _e( 'Default Blog Settings', 'bp-groupblog' ) ?></h3>
			        ...
			        <th><?php _e( 'Default Post Category:', 'bp-groupblog' ) ?></th>
							<td>
								<input name="default_cat_name" type="text" id="default_cat_name" size="30" value="<?php echo($opt['default_cat_name']); ?>"  /> <?php _e( '(Overwrites "Uncategorized")', 'bp-groupblog' ) ?>
							</td>
						</tr>
						<tr valign="top">
				    	<th><?php _e( 'Default Link Category:', 'bp-groupblog' ) ?></th>
							<td>
								<input name="default_link_cat" type="text" id="default_link_cat" size="30" value="<?php echo($opt['default_link_cat']); ?>"  /> <?php _e( '(Overwrites "Blogroll")', 'bp-groupblog' ) ?>
							</td>
						</tr>
						<tr>
							...
							<td>
				       		...
				       		<input name="delete_first_post" type="checkbox" id="delete_first_post" value="1" <?php if ($opt['delete_first_post'] == 1) echo('checked="checked"'); ?> /> <?php _e( 'Yes', 'bp-groupblog' ) ?> <?php _e( '(Default Post "Hello World")', 'bp-groupblog' ) ?>
				       	</label>
							</td>
						</tr>
				    <tr>
					        ...
					        <input name="delete_first_comment" type="checkbox" id="delete_first_comment" value="1" <?php if ($opt['delete_first_comment'] == 1) echo('checked="checked"'); ?> /> <?php _e( 'Yes', 'bp-groupblog' ) ?>
					       </label>
							</td>
						</tr>
						<tr>
							...
							<td>
								<label for="delete_blogroll_links">
									<input name="delete_blogroll_links" type="checkbox" id="delete_blogroll_links" value="1" <?php if ($opt['delete_blogroll_links'] == 1) echo('checked="checked"'); ?> /> <?php _e( 'Yes', 'bp-groupblog' ) ?>
								</label>
							</td>
						</tr>
						</tbody>
					...
					<table class="form-table">
						...
						<tr>
							...
							<td>
				       		...
				       		<input name="bp_groupblog_allowdashes" type="checkbox" id="bp_groupblog_allowdashes" value="1" <?php if ($opt['allowdashes']== 1) echo 'checked="checked"'; ?> /> <?php _e( 'Dashes', 'bp-groupblog' ) ?> <?php _e( '(Default: Not Allowed)', 'bp-groupblog' ) ?>
				       	</label>
							</td>
						</tr>
				    <tr>
				    	<th></th>
					        ...
					        <input name="bp_groupblog_allowunderscores" type="checkbox" id="bp_groupblog_allowunderscores" value="1" <?php if ($opt['allowunderscores']== 1) echo 'checked="checked"'; ?> /> <?php _e( 'Underscores', 'bp-groupblog' ) ?> <?php _e( '(Default: Not Allowed)', 'bp-groupblog' ) ?>
					       </label>
							</td>
						</tr>
						<tr>
							...
							<td>
								<label for="bp_groupblog_allownumeric">
									<input name="bp_groupblog_allownumeric" type="checkbox" id="bp_groupblog_allownumeric" value="1" <?php if ($opt['allownumeric']== 1) echo 'checked="checked"'; ?> /> <?php _e( 'All Numeric Names', 'bp-groupblog' ) ?> <?php _e( '(Default: Not Allowed)', 'bp-groupblog' ) ?>
								</label>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input name="bp_groupblog_minlength" style="width: 10%;" id="bp_groupblog_minlenth" value="<?php echo $opt['minlength'];?>" size="10" type="text" /> <?php _e( '(Default: 4 Characters)', 'bp-groupblog' ) ?>
							</td>
						</tr>
						</tbody>
					</table>
